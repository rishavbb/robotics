...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /workspace/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /workspace/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ball_chaser/${idir}'.  ${_report}")
    endif()
